...
lyr_Gravity_9.set('fieldLabels', {'ID': 'header label', 'DIAMETER__': 'header label', 'MATERIAL': 'header label', 'COMMENT': 'header label', 'DATE': 'header label', 'TIME': 'inline label', 'PHOTO': 'no label', 'GNSS_3DLEN': 'inline label', });
