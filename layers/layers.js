...
lyr_ForceMain_10.set('fieldAliases', {'ID': 'ID', 'MATERIAL': 'MATERIAL', 'DIAMETER__': 'DIAMETER__', 'COMMENT': 'COMMENT', 'DATE': 'DATE', 'TIME': 'TIME', 'PHOTO': 'PHOTO', 'GNSS_3DLEN': 'GNSS_3DLEN', 'Corr_Type': 'Corr_Type', 'GPS_Date': 'GPS_Date', 'GPS_Time': 'GPS_Time', 'Filt_Pos': 'Filt_Pos', 'Avg_Vert_P': 'Avg_Vert_P', 'Avg_Horz_P': 'Avg_Horz_P', 'Line_ID': 'Line_ID', });
...
lyr_Cleanou_12.set('fieldAliases', {'ID': 'ID', 'Diameter__': 'Diameter__', 'Type': 'Type', 'Material': 'Material', 'Comment': 'Comment', 'Date': 'Date', 'Time': 'Time', 'Photo': 'Photo', 'GNSS_Heigh': 'GNSS_Heigh', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Corr_Type': 'Corr_Type', 'GPS_Time': 'GPS_Time', 'GPS_Date': 'GPS_Date', 'Filt_Pos': 'Filt_Pos', 'Vert_Prec': 'Vert_Prec', 'Horz_Prec': 'Horz_Prec', });
lyr_Lamphole_13.set('fieldAliases', {'ID': 'ID', 'OLD_ID': 'OLD_ID', 'DIAMETER__': 'DIAMETER__', 'COMMENT': 'COMMENT', 'DATE': 'DATE', 'TIME': 'TIME', 'PHOTO': 'PHOTO', 'GNSS_HEIGH': 'GNSS_HEIGH', 'LATITUDE': 'LATITUDE', 'LONGITUDE': 'LONGITUDE', 'Corr_Type': 'Corr_Type', 'GPS_Date': 'GPS_Date', 'GPS_Time': 'GPS_Time', 'Filt_Pos': 'Filt_Pos', 'Horz_Prec': 'Horz_Prec', 'Vert_Prec': 'Vert_Prec', });
...
lyr_ForceMainValve_15.set('fieldAliases', {'ID': 'ID', 'TYPE': 'TYPE', 'MATERIAL': 'MATERIAL', 'SIZE__IN_': 'SIZE__IN_', 'COMMENT': 'COMMENT', 'DATE': 'DATE', 'TIME': 'TIME', 'PHOTO': 'PHOTO', 'GNSS_HEIGH': 'GNSS_HEIGH', 'LATITUDE': 'LATITUDE', 'LONGITUDE': 'LONGITUDE', 'Corr_Type': 'Corr_Type', 'GPS_Date': 'GPS_Date', 'GPS_Time': 'GPS_Time', 'Filt_Pos': 'Filt_Pos', 'Vert_Prec': 'Vert_Prec', 'Horz_Prec': 'Horz_Prec', });
lyr_MiscPoint_16.set('fieldAliases', {'COMMENT': 'COMMENT', 'GNSS_HEIGH': 'GNSS_HEIGH', 'LATITUDE': 'LATITUDE', 'LONGITUDE': 'LONGITUDE', 'Corr_Type': 'Corr_Type', 'GPS_Date': 'GPS_Date', 'GPS_Time': 'GPS_Time', 'Filt_Pos': 'Filt_Pos', 'Vert_Prec': 'Vert_Prec', 'Horz_Prec': 'Horz_Prec', });
...
lyr_ForceMain_10.set('fieldImages', {'ID': 'TextEdit', 'MATERIAL': 'TextEdit', 'DIAMETER__': 'TextEdit', 'COMMENT': 'TextEdit', 'DATE': 'DateTime', 'TIME': 'TextEdit', 'PHOTO': 'TextEdit', 'GNSS_3DLEN': 'TextEdit', 'Corr_Type': '', 'GPS_Date': '', 'GPS_Time': '', 'Filt_Pos': '', 'Avg_Vert_P': '', 'Avg_Horz_P': '', 'Line_ID': '', });
...
lyr_Cleanou_12.set('fieldImages', {'ID': 'TextEdit', 'Diameter__': 'TextEdit', 'Type': 'TextEdit', 'Material': 'TextEdit', 'Comment': 'TextEdit', 'Date': 'TextEdit', 'Time': 'TextEdit', 'Photo': 'TextEdit', 'GNSS_Heigh': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Corr_Type': '', 'GPS_Time': '', 'GPS_Date': '', 'Filt_Pos': '', 'Vert_Prec': '', 'Horz_Prec': '', });
lyr_Lamphole_13.set('fieldImages', {'ID': 'TextEdit', 'OLD_ID': 'TextEdit', 'DIAMETER__': 'TextEdit', 'COMMENT': 'TextEdit', 'DATE': 'DateTime', 'TIME': 'TextEdit', 'PHOTO': 'TextEdit', 'GNSS_HEIGH': 'TextEdit', 'LATITUDE': 'TextEdit', 'LONGITUDE': 'TextEdit', 'Corr_Type': '', 'GPS_Date': '', 'GPS_Time': '', 'Filt_Pos': '', 'Horz_Prec': '', 'Vert_Prec': '', });
...
lyr_ForceMainValve_15.set('fieldImages', {'ID': 'TextEdit', 'TYPE': 'TextEdit', 'MATERIAL': 'TextEdit', 'SIZE__IN_': 'TextEdit', 'COMMENT': 'TextEdit', 'DATE': 'TextEdit', 'TIME': 'TextEdit', 'PHOTO': 'TextEdit', 'GNSS_HEIGH': 'TextEdit', 'LATITUDE': 'TextEdit', 'LONGITUDE': 'TextEdit', 'Corr_Type': '', 'GPS_Date': '', 'GPS_Time': '', 'Filt_Pos': '', 'Vert_Prec': '', 'Horz_Prec': '', });
lyr_MiscPoint_16.set('fieldImages', {'COMMENT': 'TextEdit', 'GNSS_HEIGH': 'TextEdit', 'LATITUDE': 'TextEdit', 'LONGITUDE': 'TextEdit', 'Corr_Type': '', 'GPS_Date': '', 'GPS_Time': '', 'Filt_Pos': '', 'Vert_Prec': '', 'Horz_Prec': '', });
...
lyr_ForceMain_10.set('fieldLabels', {'ID': 'header label', 'MATERIAL': 'header label', 'DIAMETER__': 'header label', 'COMMENT': 'header label', 'DATE': 'header label', 'TIME': 'header label', 'PHOTO': 'header label', 'GNSS_3DLEN': 'header label', 'Corr_Type': 'no label', 'GPS_Date': 'no label', 'GPS_Time': 'no label', 'Filt_Pos': 'no label', 'Avg_Vert_P': 'no label', 'Avg_Horz_P': 'no label', 'Line_ID': 'no label', });
...
lyr_ForceMainValve_15.set('fieldLabels', {'ID': 'inline label', 'TYPE': 'header label', 'MATERIAL': 'header label', 'SIZE__IN_': 'header label', 'COMMENT': 'header label', 'DATE': 'inline label', 'TIME': 'inline label', 'PHOTO': 'no label', 'GNSS_HEIGH': 'inline label', 'LATITUDE': 'inline label', 'LONGITUDE': 'inline label', 'Corr_Type': 'no label', 'GPS_Date': 'no label', 'GPS_Time': 'no label', 'Filt_Pos': 'no label', 'Vert_Prec': 'no label', 'Horz_Prec': 'no label', });
lyr_MiscPoint_16.set('fieldLabels', {'COMMENT': 'inline label', 'GNSS_HEIGH': 'inline label', 'LATITUDE': 'inline label', 'LONGITUDE': 'inline label', 'Corr_Type': 'no label', 'GPS_Date': 'no label', 'GPS_Time': 'no label', 'Filt_Pos': 'no label', 'Vert_Prec': 'no label', 'Horz_Prec': 'no label', });
...
lyr_Villa_Line_gen_20.set('fieldLabels', {'Comment': 'header label', 'GNSS_3DLen': 'header label', 'Corr_Type': 'no label', 'GPS_Date': 'header label', 'GPS_Time': 'header label', });
