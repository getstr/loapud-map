...
lyr_Villa_VTanks_19.set('fieldLabels', {'ID': 'header label', 'PUMP_OR_GR': 'header label', 'COMMENT': 'header label', 'DATE': 'header label', 'TIME': 'no label', 'PHOTO': 'inline label', 'PHOTO2': 'header label', 'GNSS_HEIGH': 'inline label', 'LATITUDE': 'inline label', 'LONGITUDE': 'inline label', 'MAP_ICON': 'header label', 'Corr_Type': 'header label', 'GPS_Date': 'header label', 'GPS_Time': 'header label', 'Unfilt_Pos': 'header label', 'Vert_Prec': 'header label', 'Horz_Prec': 'inline label', 'Point_ID': 'no label', 'layer': 'no label', 'path': 'no label', });
lyr_Villa_Line_gen_20.set('fieldLabels', {'Comment': 'inline label', 'GNSS_3DLen': 'header label', 'Corr_Type': 'no label', 'GPS_Date': 'header label', 'GPS_Time': 'header label', });
