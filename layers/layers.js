...
lyr_ForceMain_10.set('fieldLabels', {'ID': 'header label', 'MATERIAL': 'header label', 'DIAMETER__': 'header label', 'COMMENT': 'header label', 'DATE': 'header label', 'TIME': 'header label', 'PHOTO': 'header label', 'GNSS_3DLEN': 'header label', });
